...
promiseList.push((async () => {
    ...
    async function EnhancedAlchemyNode(node, grade, researchButton, researchComp, researchPotion, forgetNode, brewButton, brewSelect) {
    ...
    function EnhancedAlchemyPanelUI(trackerNode) {
